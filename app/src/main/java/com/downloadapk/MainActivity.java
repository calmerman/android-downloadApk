...
import com.downloadapkutil.DownloadApkProgressListener;
import com.downloadapkutil.DownloadApkUtil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tv_download).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                downloadApkUtil.startDownloadAPKByUrl("http://imtt.dd.qq.com/16891/BF302D86013B6105A446C11C9CE3F007.apk?fsname=com.u17.comic.phone_3.4.0.1_3400100.apk&csr=1bbd","3400100");
            }
        });
